...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './courses.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ICourses, defaultValue } from 'app/shared/model/courses.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSES_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSES actions', async () => {
      const expectedActions = [
        {
