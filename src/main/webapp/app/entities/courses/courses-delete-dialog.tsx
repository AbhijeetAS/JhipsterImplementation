...
export const CoursesDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterFinalProjectApp.courses.delete.question">
        <Translate contentKey="jhipsterFinalProjectApp.courses.delete.question" interpolate={{ id: coursesEntity.id }}>
